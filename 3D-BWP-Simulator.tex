...
%Dalam fisika dan matematika, urutan angka n dapat dipahami sebagai lokasi dalam ruang n-dimensi. Ketika n = 3, himpunan semua lokasi tersebut disebut tiga dimensi ruang Euclidean. Hal ini umumnya diwakili oleh simbol \ scriptstyle {\ mathbb {R}} ^ 3. Ruang ini hanya salah satu contoh dari berbagai ruang dalam tiga dimensi yang disebut 3-manifold.
